...
_EN_STOPWORDS = frozenset(
    [
        ...
        "report",
        "reports",
        # 일반 영어 동사 — 화제 이름이 되면 뜻이 전혀 다른 기사를 한 단어로 엮는다
        # (라이브 실측: 'contain'이 "스페인 산불 진화"와 "I Contain Multitudes"라는
        # Git 저장소 잡담을 하나의 화제로 병합 → 신뢰도 훼손). 일반동사는 개체가
        # 아니므로 화제 후보에서 통째로 제외한다.
        "contain",
        "contains",
        "contained",
        "containing",
